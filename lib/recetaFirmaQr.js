...
// pdfjs-dist siempre necesita saber dónde está su "worker" (real o simulado en el
// mismo hilo, según el entorno) — sin esto, en la función serverless de Vercel tira
// "Setting up fake worker failed: Cannot find module .../pdf.worker.mjs" (confirmado
// en producción, 2026-08-20): el empaquetado de Vercel no incluye ese archivo salvo
// que algo lo referencie explícito. Resolverlo con import.meta.resolve (no una ruta
// relativa a mano) es lo que hace que SÍ quede incluido en el bundle final.
