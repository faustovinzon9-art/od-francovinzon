...
// Marcador de "feriado que se atiende" (feature 2026-08-24): evento all-day en
// CALENDAR_ID con este texto en la description — la tarea "¿Se atiende este día?" no
// vuelve a preguntar por un feriado que ya tiene este marcador. Mismo patrón de evento
// marcador que BLOCK_MARKER (sin base de datos propia).
export const FERIADO_ATENDIDO_MARKER = 'FERIADO_ATENDIDO';
...
// Compartido por api/disponibilidad.js (paciente, público) y api/reservar.js (creación
// de turnos) — misma lógica en los dos caminos, para no tener dos formas distintas de
// calcular "qué horarios quedan libres" o de crear el evento. (Hubo un api/chat.js que
// también lo usaba — el chatbot fue eliminado el 2026-08-13, ver changelog.)
...
// debe venir en E.164 (selector de país del formulario). "origen" solo cambia la última
// línea de la descripción, para poder distinguir el canal que creó el turno
// ('formulario' de /turnos, 'gestion' del panel, 'conversion-sobreturno'; 'chat' queda
// como legado del chatbot eliminado el 2026-08-13).
