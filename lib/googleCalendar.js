...
export async function crearTurno(calendar, { date, time, nombre, apellido, telefono, dni, motivo, esNuevo, origen, slotMinutes = SLOT_MINUTES }) {
...
// Los tres clientes se devuelven SIN envolver — ver el incidente 2026-08-12 en
