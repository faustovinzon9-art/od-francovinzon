...
// Sin envolver con reintentos — ver el comentario del incidente en getCalendarClient()
// de lib/googleCalendar.js (envolverConReintentos rompía producción entera).
...
// Cliente OAuth crudo (no envuelto en drive/sheets) — hace falta para pedidos
// autenticados a URLs que no son parte de la API REST normal, como los exportLinks de
// una revisión puntual de Drive (ver investigación 2026-08-20, api/gestion/pacientes.js).
export function getPacientesAuthClient() {
