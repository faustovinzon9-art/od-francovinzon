...
// Solo para el backfill inicial (ver decisions.md, utilitarios de un solo uso) —
// sobrescribe TODA la planilla de una sola vez con las filas ya armadas en memoria, en
// vez de upsertear una por una (evitaría un read-por-fila que con cientos de pacientes
// sería lentísimo — O(n²)).
